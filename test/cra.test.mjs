...
const entries = [
  { date: '2026-09-03', client: 'DE RIJKE FRANCE', project: 'BS-26-000086 [Projet Principal]', projectCode: '98567|ATE', days: 0.5, note: '  atelier  ' },
  { date: '2026-09-01', client: 'SERGIC', project: 'BS-25-000012 [TMA]', projectCode: '1|X', days: 1, note: '' },
  { date: '2026-09-01', client: 'DE RIJKE FRANCE', project: 'BS-26-000086 [Projet Principal]', projectCode: '98567|ATE', days: '0.125', note: '' },
  { date: '2026-09-02', client: 'SERGIC', project: '', projectCode: undefined, days: 1, note: 'incomplete: no project' },
  { date: '2026-08-31', client: 'SERGIC', project: 'BS-25-000012 [TMA]', projectCode: '1|X', days: 1, note: 'other month' },
];

test('keeps complete rows of the month, sorted by date then project, trimmed', () => {
  const { payload, problems, hours, skipped } = buildCraPayload(entries, { month: '2026-09', person: ' Fabien DUCOUDRAY ' });
  ...
  assert.deepEqual(payload.rows, [
    ...
    { date: '2026-09-01', client: 'DE RIJKE FRANCE', project: 'BS-26-000086 [Projet Principal]', days: 0.125, task: '' },
...
test('reports rows whose days are not a whole number of hours', () => {
  const bad = [{ date: '2026-09-04', client: 'SERGIC', project: 'BS-25-000012 [TMA]', days: 0.3, note: '' }];
...
test('serialization is one line even with line separators in a task', () => {
  ...
  const rows = [{ date: '2026-09-01', client: 'A', project: 'BS-26-000001 [x]', days: 1, note }];
