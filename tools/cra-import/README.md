...
4. Cliquez **Exécuter**. Le volet affiche un rapport par onglet (`Camille DUPONT : colonne Source ajoutée`…). Vérifiez sur un onglet : une colonne **Source** en I27, la cellule jaune **I23** « ← Coller ici le bloc VSA Ext », et la ligne 22 un peu plus haute (30 pt) pour loger le bouton. Affichez `_Modele` (clic droit sur un onglet → Afficher) pour vérifier qu'il l'a aussi, puis remasquez-le.
